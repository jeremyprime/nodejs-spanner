...
describe('MetricsTracer', () => {
  ...
  describe('recordGfeConnectivityErrorCount', () => {
    ...
    it('should not increment if disabled or gfeEnabled is false', () => {
      tracer.enabled = false;
      tracer.recordGfeConnectivityErrorCount();
